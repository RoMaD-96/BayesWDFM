...
comparison_ligue_half_100 <- compare_foot(source = list(
...
comparison_ligue_half_100



save(comparison_ligue_half_100, file = "RData/Ligue_1/comparison_ligue_1_half_100.RData")
