...
load("RData/Bundesliga/time_results_bundes_half_9.RData")
load("RData/La_Liga/time_results_liga_half_10.RData")
load("RData/Premier_League/time_results_premier_half_10.RData")
