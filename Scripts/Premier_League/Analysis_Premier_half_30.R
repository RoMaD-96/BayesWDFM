...
comparison_premier_half_30 <- compare_foot(source = list(
...
comparison_premier_half_30

save(comparison_premier_half_30, file = "comparison_premier_half_30.RData")
...
save(stats_premier, file = "RData/Premier_League/stats_premier_half_30.RData")
