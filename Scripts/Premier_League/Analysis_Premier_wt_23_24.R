...
save(comparison_premier_wt, file = "RData/Premier_League/comparison_premier_wt_23_24.RData")
...
save(score_metrics, file = "RData/Premier_League/score_metrics_premier_wt_23_24.RData")
...
save(stats_premier, file = "RData/Premier_League/stats_premier_wt_23_24.RData")
