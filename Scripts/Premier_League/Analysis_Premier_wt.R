...
comparison_premier_wt <- compare_foot(source = list(
  ...
  zero_skellam_kl = zero_skellam_kl), test_data = premier_test)

comparison_premier_wt

save(comparison_premier_wt, file = "RData/Premier_League/comparison_premier_wt.RData")
...
save(score_metrics, file = "RData/Premier_League/score_metrics_premier_wt.RData")
...
save(stats_premier, file = "RData/Premier_League/stats_premier_wt.RData")
