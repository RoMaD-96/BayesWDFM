...
comparison_bundes_wt <- compare_foot(source = list(
...
comparison_bundes_wt

save(comparison_bundes_wt, file = "RData/Bundesliga/comparison_bundes_wt.RData")
...
save(score_metrics, file = "RData/Bundesliga/score_metrics_bundes_wt.RData")
...
save(stats_bundes, file = "RData/Bundesliga/stats_bundes_wt.RData")
View(stats_bundes)
