...
save(comparison_bundes_wt, file = "RData/Bundesliga/comparison_bundes_wt_23_24.RData")
...
save(score_metrics, file = "RData/Bundesliga/score_metrics_bundes_wt_23_24.RData")
...
save(stats_bundes, file = "RData/Bundesliga/stats_bundes_wt_23_24.RData")
View(stats_bundes)
