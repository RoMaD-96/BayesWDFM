...
comparison_bundes_half_27 <- compare_foot(source = list(
  biv_pois_comm = biv_pois_comm,
...
comparison_bundes_half_27

save(comparison_bundes_half_27, file = "RData/Bundesliga/comparison_bundes_half_27.RData")
...
save(stats_bundes, file = "RData/Bundesliga/stats_bundes_half_27.RData")
View(stats_bundes)
