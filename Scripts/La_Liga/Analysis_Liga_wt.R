...
save(comparison_la_liga_wt, file = "RData/La_Liga/comparison_la_liga_wt.RData")
...
save(score_metrics, file = "RData/La_Liga/score_metrics_la_liga_wt.RData")
...
save(stats_liga, file = "RData/La_Liga/stats_la_liga_wt.RData")
