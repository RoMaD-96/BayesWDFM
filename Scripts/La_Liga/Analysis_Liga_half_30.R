...
comparison_liga_half_30 <- compare_foot(source = list(
...
comparison_liga_half_30

save(comparison_liga_half_30, file = "RData/La_Liga/comparison_liga_half_30.RData")
...
save(stats_liga, file = "RData/La_Liga/stats_liga_half_30.RData")
